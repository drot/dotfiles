...
beautiful.init("/home/drot/.config/awesome/themes/dust/theme.lua")
...
tags = {
	names  = { "ter", "www", "irc", "mpd", "gtk", "vid", "lrn", "bkp", "misc" },
	layout = { layouts[1], layouts[3], layouts[1], layouts[7], layouts[7], layouts[7], layouts[1], layouts[1], layouts[1] }
	}
...
vicious.cache(vicious.widgets.ossvol)
-- Register widgets
vicious.register(volbar,    vicious.widgets.ossvol, "$1",  2, "vol")
vicious.register(volwidget, vicious.widgets.ossvol, "$1%", 2, "vol")
-- Register buttons
volbar.widget:buttons(awful.util.table.join(
   awful.button({ }, 1, function () awful.util.spawn("ossmix vol +5", false) end),
   awful.button({ }, 3, function () awful.util.spawn("ossmix vol -- -5", false) end)
...
for _, w in pairs(fs) do
   ...
   w:set_height(12):set_width(5):set_ticks_size(1)
