...
(use-package which-key
  ...
  (which-key-add-prefix-title "C-c h" "help")
  (which-key-add-prefix-title "C-c i" "insertion")
  (which-key-add-prefix-title "C-c m" "multiple-cursors")
  (which-key-add-prefix-title "C-c n" "navigation")
  (which-key-add-prefix-title "C-c o" "org")
  (which-key-add-prefix-title "C-c s" "search-and-symbols")
  (which-key-add-prefix-title "C-c t" "toggles")
  (which-key-add-prefix-title "C-c v" "version-control")
  (which-key-add-prefix-title "C-c w" "windows-and-frames")
  (which-key-add-prefix-title "C-c x" "text")
  (which-key-mode))
