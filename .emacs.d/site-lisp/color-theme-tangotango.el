...
(defun color-theme-tangotango ()
  ...
  (color-theme-install
   '(color-theme-tangotango
     ...
     (ido-first-match ((t (:foreground "#6ac214"))))
     (ido-only-match ((t (:foreground "dodger blue"))))
     (ido-subdir ((t (:foreground "tomato"))))
     (erc-notice-face ((t (:foreground "#bbbbbc" :weight normal))))
     (erc-error-face ((t (:foreground "tomato"))))
     (erc-input-face ((t (:foreground "#6ac214"))))
     ...
     (erc-timestamp-face ((t (:foreground "#888a85" :weight normal))))
